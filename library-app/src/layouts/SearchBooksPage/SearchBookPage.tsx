...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      setTotalBooks(json.page.totalElements);
    ...
    window.scrollTo(0, 0);
  }, [currentPage, searchUrl]); // each time current page changes execute this webhook
          ...
          <div className="row mt-5">
            ...
            {totalBooks > 0 ? (
              ...
              <div className="m-5">
                ...
                <a
                  type="button"
                  className="btn btn-color main-color btn-md px-4 me-md-2 fw-bold text-white"
                  href="#"
                >
                  Library Services
                </a>
